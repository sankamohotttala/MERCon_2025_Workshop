...
ml_keywords_loaded = pd.read_csv(r"F:\Personal\Sanka\mercon\sicet_2025_proposal_analysis\nn_keywords.csv")
...
output_csv_path = os.path.join(r'F:\Personal\Sanka\mercon\sicet_2025_proposal_analysis\tmp','nn_international_all.csv')
